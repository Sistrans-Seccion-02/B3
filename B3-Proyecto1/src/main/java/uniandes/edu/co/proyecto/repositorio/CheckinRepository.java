...
public interface CheckinRepository extends JpaRepository<Checkin, Integer> {
    ...
    Gimnasio darCheckin(@Param("id") Integer id);
    ...
    void actualizarCheckout(@Param("id") Integer id, @Param("fechaEntrada") Date fechaEntrada, @Param("responsable") Cliente responsable, @Param("responsableHotel") Empleado responsableHotel);
