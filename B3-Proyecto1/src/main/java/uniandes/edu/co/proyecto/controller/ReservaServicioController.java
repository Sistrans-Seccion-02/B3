...
public class ReservaServicioController {
    ...
    public String reservaServGuardar(@ModelAttribute ReservaServicio reserva){
        reservaServicioRepository.insertarReserva(reserva.getFecha(), reserva.getIdServicio(), reserva.getCosto(), reserva.getHabitacion());
    ...
    public String reservaEditarGuardar(@PathVariable("id") int id, @ModelAttribute ReservaServicio reserva){
        reservaServicioRepository.actualizarReserva(id, reserva.getFecha(), reserva.getIdServicio(), reserva.getCosto(), reserva.getHabitacion());
        return "redirect:/reservas_servicio";
